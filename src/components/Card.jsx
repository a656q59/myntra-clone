    ...
    return (
        <div className="card"  style={{width:"20rem", height:"30rem"}}  onClick={props.onClick}>
          ...
          <div className="card-body">
            ...
            <Link to={resolvd.pathname.includes('/products/category')||resolvd.pathname.includes('/products')?`/products/${props.id}`:`/products/category/${props.name}`} className="btn btn-primary " onClick={()=>props.onClick(props.id)}>Go somewhere</Link>
          </div>
        </div>
    );
}
